...
lf <- list.files(path = "/Users/nikolasgestrich/Documents/github/EFA_TripartiteApproach/analysis/data/trial_data/Trial traces01", # shorten this, maybe using here::here function
...
lf1 <- lf1 %>% separate(V11, c("project", "type", "sort", "number"))
...
allDiatomOutlines.f <- efourier(allDiatomOutlines, norm = TRUE, nb.h=14) #Num. of harmonics set to 32
```
