...
lf <- list.files("C:/Users/Pedersen/Documents/R/EFA_TripartiteApproach/analysis/data/trial_data/Trial traces01", pattern = "\\.txt$", full.names=TRUE)  
```
...
lf1 <- lf_structure(lf,  split = "C:/Users/Pedersen/Documents/R/EFA_TripartiteApproach/analysis/data/trial_data/Trial traces01", trim.extension = FALSE)
```
