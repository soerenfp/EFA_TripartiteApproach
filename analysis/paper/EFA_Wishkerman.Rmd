...
lf <- list.files(path = here::here("analysis/data/trial_data/Trial traces01"), 
...
allDiatomOutlines.f <- efourier(allDiatomOutlines, norm = TRUE, nb.h=18) #Num. of harmonics set to 32
```
